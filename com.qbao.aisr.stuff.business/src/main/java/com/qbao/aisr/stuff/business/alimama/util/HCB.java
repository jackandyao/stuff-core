...
public class HCB extends HttpClientBuilder{
	 ...
	 */
	public HCB ssl() throws Exception {
...
//		return (HCB) this.setConnectionManager(connManager);
	 ...
	 * @throws HttpProcessException
	 */
	public HCB ssl(String keyStorePath) throws Exception{
	 ...
	 * @throws HttpProcessException
	 */
	public HCB ssl(String keyStorePath, String keyStorepass) throws Exception{
...
//		this.isNewSSL=true;
	 ...
	 * @throws HttpProcessException
	 */
	public HCB pool(int maxTotal, int defaultMaxPerRoute) throws Exception{
		Registry<ConnectionSocketFactory> socketFactoryRegistry = RegistryBuilder
				.<ConnectionSocketFactory> create()
				.register("http", PlainConnectionSocketFactory.INSTANCE)
