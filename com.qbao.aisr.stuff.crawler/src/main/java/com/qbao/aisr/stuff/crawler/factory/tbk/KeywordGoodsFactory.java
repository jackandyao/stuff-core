 ...
 */
@Component(value="keywordGoodsFactory")
public class KeywordGoodsFactory extends CrawlerAbstractFactory{

    @Override
    public CrawlerContext init() throws IOException, CrawlerException {

        super.crawlerContext = new CrawlerContext(new  CrawlerConfig("alimama_keyword_crawler.properties"));
