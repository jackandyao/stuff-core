 ...
 * $$LastChangedBy$$
 */
@Component(value="alimamaGoodsPromotionUrlTaskProvide")
public class AlimamaGoodsPromotionUrlTaskProvide implements ICrawlerProvide {

    Logger logger = LoggerFactory.getLogger(AlimamaGoodsPromotionUrlTaskProvide.class);
        ...
        while(isLoop){
            ...
            if(old!=null){
                if(old.getAndroidPromotionUrl()!=null){
                    if(old.getAndroidPromotionUrl().startsWith("https://s.click.taobao.com")){
                        ...
                        if(stuffPromotion.getIosPromotionUrl()!=null&&stuffPromotion.getIosPromotionUrl().startsWith("https://s.click.taobao.com")){
