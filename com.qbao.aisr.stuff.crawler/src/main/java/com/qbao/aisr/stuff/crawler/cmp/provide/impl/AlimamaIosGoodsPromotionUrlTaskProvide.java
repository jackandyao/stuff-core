 ...
 * $$LastChangedBy$$
 */
@Component(value="alimamaIosGoodsPromotionUrlTaskProvide")
public class AlimamaIosGoodsPromotionUrlTaskProvide implements ICrawlerProvide {

    Logger logger = LoggerFactory.getLogger(AlimamaIosGoodsPromotionUrlTaskProvide.class);
        ...
        while(isLoop){
            ...
            if(old!=null){
                if(old.getIosPromotionUrl()!=null){
                    if(old.getIosPromotionUrl().startsWith("https://s.click.taobao.com")){
                        ...
                        if(stuffPromotion.getAndroidPromotionUrl()!=null&&stuffPromotion.getAndroidPromotionUrl().startsWith("https://s.click.taobao.com")){
