...
import com.qbao.aisr.stuff.crawler.factory.tbk.TbkPCGoodsPromotionUrlCrawlerFactory;
...
//                CrawlerService crawlerService = ctx.getBean(CrawlerService.class);
//                //ios
                CrawlerAbstractFactory tbkIosGoodsPromotionUrlCrawlerFactory = ctx.getBean("tbkPCGoodsPromotionUrlCrawlerFactory", TbkPCGoodsPromotionUrlCrawlerFactory.class);
                try {
