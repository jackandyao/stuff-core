...
import com.qbao.aisr.stuff.crawler.factory.tbk.KeywordGoodsFactory;
 ...
 * $$LastChangedDate: 2017-06-13 17:54:48 +0800 (Tue, 13 Jun 2017) $$
 * $$LastChangedRevision: 1194 $$
 * $$LastChangedBy: liaijun $$
 */
@SuppressWarnings("all")
public class CrawlerKeywordRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread baseThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //下载商品
                CrawlerAbstractFactory keywordGoodsFactory = ctx.getBean("keywordGoodsFactory",KeywordGoodsFactory.class);
                try {
                    crawlerService.init(keywordGoodsFactory);
                    crawlerService.start(keywordGoodsFactory);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
